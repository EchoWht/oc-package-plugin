 ...
 */
Route::resource('api/v1/url', 'Blskye\Package\Controllers\api\urlController', ['except' => ['destroy', 'create', 'edit']])->middleware('\Tymon\JWTAuth\Middleware\GetUserFromToken');
